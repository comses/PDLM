...
class Sensor(AtomicDEVS):
    ...
    def __init__(self, name=None, id=None, kwargs=None):
        ...
        self.light_status_port = self.addInPort("light_status")

        # Set out ports

        self.control_feedback_port = self.addOutPort("control_feedback")
    ...
    def outputFnc(self):
        ...
        control_feedback = self.control_feedback_port.getPortName()
